...
<body class="bg-green-50 text-gray-800">
    ...
    <div class="min-h-screen flex flex-col items-center pt-24 pb-8 px-4 sm:px-6 lg:px-8">
        ...
        <!-- Quiz Header Card -->
        <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-md w-full max-w-md text-center transition transform">
        ...
        <!-- Instructions Card -->
        <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-md w-full max-w-md mt-6 mb-6 transition transform">
