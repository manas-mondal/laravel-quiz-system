...
<body class="bg-green-100 flex flex-col items-center justify-center min-h-screen p-2 md:p-6 select-none">
    ...
    <div
        ...
        <!-- ✅ Watermark -->
        <img src="{{ asset('images/quiz-logo.png') }}" class="watermark animate-fadeUp" alt="Quizify Logo Watermark">
        ...
        <div class="content-layer">
            ...
            <!-- Ribbon -->
            <div
                class="absolute -top-16 left-1/2 transform -translate-x-1/2 bg-yellow-500 text-white font-semibold px-4 sm:px-8 py-1.5 sm:py-2 rounded-full shadow-lg tracking-wide text-sm sm:text-base animate-fadeUp">
                CERTIFICATE
            </div>

            <!-- Gold Badge -->
            <img src="{{ asset('images/gold-badge.png') }}"
                class="h-24 sm:h-32 w-24 sm:w-32 mx-auto mt-2 sm:mt-1 mb-3 animate-fadeUp" alt="Gold Badge">

            <!-- Title -->
            <h1 class="text-2xl sm:text-4xl font-extrabold text-green-800 tracking-wide leading-tight animate-fadeUp">
                Certificate of Achievement
            </h1>

            <!-- Subtitle -->
            <p class="text-gray-700 text-base sm:text-lg mt-2 italic animate-fadeUp">
                This is proudly awarded to
            </p>

            <!-- Recipient Name -->
            <div class="mt-3 text-2xl sm:text-3xl font-bold text-yellow-700 uppercase break-words animate-fadeUp">
                {{ $user->name }}
            </div>
            ...
            <!-- Description -->
            <p class="mt-5 sm:mt-6 text-gray-700 leading-relaxed text-base sm:text-lg px-3 animate-fadeUp">
            ...
            <!-- Score -->
            <p class="mt-4 text-gray-700 text-base sm:text-lg animate-fadeUp">
                Score: <span class="font-bold text-yellow-700">{{ round($record->score) }}%</span>
            </p>

            <!-- Certificate ID -->
            <p class="mt-3 text-gray-700 text-base sm:text-lg break-all animate-fadeUp">
                Certificate ID:
            ...
            <!-- QR Code -->
            <div class="mt-6 flex justify-center animate-fadeUp">
                {!! QrCode::size(120)->generate(url('/verify-certificate') . '?certificate_id=' . $record->certificate_id) !!}
            </div>

            <!-- Verification Link -->
            <p class="mt-3 text-gray-500 text-xs sm:text-sm break-all animate-fadeUp">
                Verify at:
            ...
            <!-- Award Date -->
            <p class="mt-6 text-gray-600 text-sm sm:text-base animate-fadeUp">
                Awarded on:
                <span class="font-medium">{{ $record->updated_at->format('d M, Y') }}</span>
            </p>

            <!-- Signatures -->
            <div class="mt-10 flex justify-between items-end px-6 sm:px-16 gap-6 animate-fadeUp">
    ...
    <!-- Buttons -->
    <div class="mt-6 flex flex-wrap gap-3 sm:gap-4 no-print justify-center animate-fadeUp">
